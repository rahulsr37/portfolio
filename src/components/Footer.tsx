      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          <div>
            ...
            <p className="text-gray-400 mb-6 max-w-xs">
              A passionate software developer focusing on creating beautiful, functional, and user-friendly web applications.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start">
                ...
                <a href="mailto:Rahul@example.com" className="text-gray-400 hover:text-primary transition-colors">
                  Rahul@example.com
                </a>
              </li>
              <li className="flex items-start">
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-500 text-sm">
            © {currentYear} Rahul Singh. All rights reserved.
          </p>
